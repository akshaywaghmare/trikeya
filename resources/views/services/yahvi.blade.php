				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							<div class="swiper-slide-bg" style="background-image: url('public/theme/images/slider/dweej-5.jpg');"></div>
						</div>
					
						<div class="swiper-slide dark">
							<div class="swiper-slide-bg" style="background-image: url('public/theme/images/slider/dweej-6.jpg'); background-position: center top;"></div>
                        </div>
					</div>
